...
def lgb_train(num_leaves,subsample,colsample_bytree,lambda_l1,lambda_l2,min_child_weight):
    para_lgb['num_leaves']=int(num_leaves)
    para_lgb['subsample']=subsample
    para_lgb['colsample_bytree']=colsample_bytree
    para_lgb['lambda_l1']=lambda_l1
    para_lgb['lambda_l2']=lambda_l2
    para_lgb['min_child_weight']=int(min_child_weight)
...
cat_opt = BayesianOptimization(lgb_train,param_range) 
